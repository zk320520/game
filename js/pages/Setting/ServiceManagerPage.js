...
class ServiceManagerPage extends Component {
    ...
    componentDidMount() {
        ...
        requestApi.get('system/getServicePolicy', null, null, result => {
            Portal.remove(key);
            console.log(result);
            this.setState({
    ...
    _handleSubmit() {
        ...
        requestApi.postJson('system/updateServicePolicy', {
...
export default connect(mapStateToProps)(ServiceManagerPage);